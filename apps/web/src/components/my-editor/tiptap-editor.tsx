  ...
  return (
    <>
      ...
      <div className="py-4 flex items-center gap-2">
        <Button
          variant={theme === 'light' ? 'destructive' : 'ghost'}
          onClick={() => {
        ...
        <Button
          variant={theme === 'dark' ? 'destructive' : 'ghost'}
          onClick={() => {
...
const RichTextToolbar = () => {
  return (
    <div className="flex items-center gap-2 flex-wrap bg-background dark:bg-white/5">
      <RichTextUndo />
      <RichTextRedo />
...
function App({ content, onChange }: TiptapEditorProps) {
  ...
  return (
    <div
      className={
        fullScreen
          ? 'p-6 absolute left-0 right-0 bottom-0 top-0 bg-white dark:bg-background z-50 overflow-y-auto'
          : 'flex flex-col w-full max-w-5xl gap-6 mx-auto my-0'
      }
    >
