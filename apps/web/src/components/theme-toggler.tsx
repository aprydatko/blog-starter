...
const ThemeToggler = () => {
  ...
  return (
    <button
      className="flex items-center justify-center rounded-full h-9 w-9 border border-border bg-gray-100 dark:bg-accent/15 hover:dark:bg-accent hover:bg-accent/15 cursor-pointer"
      onClick={toggleTheme}
