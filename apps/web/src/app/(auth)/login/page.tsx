            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="remember" className="block text-sm/6 font-medium text-gray-900 dark:text-white">
                            Remember me
                        </Label>
                    </div>
                    <div>
                ...
                <div className='flex items-center justify-center gap-6'>
                    <Button type='button' onClick={() => signIn('google', { callbackUrl: '/' })} variant={'secondary'} size="lg" className='cursor-pointer'>
                    ...
                    <Button type='button' onClick={() => signIn('github', { callbackUrl: '/' })} variant={'secondary'} size="lg" className='cursor-pointer'>
                        <svg width="800px" height="800px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" className="fill-black dark:fill-white">
